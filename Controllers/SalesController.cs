...
namespace Act2MVC.Controllers
{
    public class SalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,numSales,amtSales,ReleaseDate")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,numSales,amtSales,ReleaseDate")] Sale sale)
        {
            if (id != sale.Id)
            {
                return NotFound();
